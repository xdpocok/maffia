...
const schema = `
  ...
  CREATE TABLE IF NOT EXISTS world_chat_messages (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    sender_profile_name VARCHAR(18) NOT NULL,
    body VARCHAR(120) NOT NULL,
    created_at BIGINT NOT NULL,
    INDEX idx_world_chat_created (created_at DESC, id DESC),
    CONSTRAINT fk_world_chat_sender FOREIGN KEY (sender_profile_name) REFERENCES players(profile_name) ON DELETE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
  ...
  CREATE TABLE IF NOT EXISTS player_action_sessions (
    action_id VARCHAR(64) PRIMARY KEY,
    profile_name VARCHAR(18) NOT NULL,
    action_type VARCHAR(32) NOT NULL,
    action_status VARCHAR(24) NOT NULL DEFAULT 'active',
    payload_json LONGTEXT NOT NULL,
    created_at BIGINT NOT NULL,
    updated_at BIGINT NOT NULL,
    expires_at BIGINT NOT NULL,
    INDEX idx_action_sessions_profile_active (profile_name, action_type, action_status, updated_at DESC),
    INDEX idx_action_sessions_expiry (action_status, expires_at),
    CONSTRAINT fk_action_sessions_player FOREIGN KEY (profile_name) REFERENCES players(profile_name) ON DELETE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
